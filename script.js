...
function initWhatsAppFunctionality() {
    ...
    whatsappButtons.forEach(button => {
        ...
        newButton.addEventListener('click', function(e) {
            ...
            let message = 'Assalamualaikum Ustadz, saya ingin bertanya tentang pendaftaran santri baru di Pesantren Modern Raudhatussalam.';
    ...
    facilityItems.forEach(item => {
        item.addEventListener('click', function() {
            ...
            img.onerror = function() {
                ...
                facilityModalImage.src = 'img/placeholder.png'; // Fallback image
            ...
            if (match && match[1]) {
                ...
                testImg.onerror = function() {
                    ...
                    if (!url.startsWith('http') && !url.startsWith('/')) {
                        ...
                        element.style.backgroundImage = 'url("img/placeholder-bg.png")';
                    }
                };
                testImg.src = url;
            }
...
function createWhatsAppLink(number, message = '') {
    ...
    if (message) {
        ...
        encodedMessage = encodeURIComponent('Assalamualaikum,Usa. saya ingin bertanya tentang pendaftaran santri baru di Pesantren Modern Raudhatussalam.');
    }
...
document.addEventListener('contextmenu', function(e) {
    e.preventDefault();
    alert("mau ngapain kau woyy?");
});

// Mencegah akses ke Developer Tools dengan pintasan keyboard
document.onkeydown = function(e) {
    // Mencegah F12 (F12 adalah tombol untuk membuka Developer Tools)
    if (e.keyCode === 123) {  
        return false;
    }
    // Mencegah Ctrl + Shift + I (untuk membuka Developer Tools di browser)
    if (e.ctrlKey && e.shiftKey && e.keyCode === 73) {  
        return false;
    }
    // Mencegah Ctrl + U (untuk melihat source code halaman)
    if (e.ctrlKey && e.keyCode === 85) {  
        return false;
    }
};

// Mencegah akses ke console dari JavaScript
(function() {
...
// Cegah pemilihan teks di halaman untuk mencegah salin kode
document.body.style.userSelect = 'none';

// Deteksi jika Developer Tools terbuka dan menampilkan peringatan
...
// Menonaktifkan inspect element dengan kode browser tertentu
document.addEventListener("keydown", function(e) {
...
// Mencegah sumber daya dari di-drag dan dilihat secara langsung
document.addEventListener('dragstart', function(e) {
    e.preventDefault();
});

// Disable right-click pada elemen tertentu, contohnya gambar atau teks
const disableRightClickOnImage = document.querySelectorAll('img, a');
disableRightClickOnImage.forEach(function(el) {
